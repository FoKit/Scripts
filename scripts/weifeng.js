...
[Script]
# > 威锋论坛签到+任务
威锋论坛 = type=cron,script-path=weifeng.js,cronexp=0 8 * * *,wake-system=1,timeout=15
...
const userName = $.getdata('feng_username') || process.env.feng_username || '';
const password = $.getdata('feng_password') || process.env.feng_password || '';
