...
!(async () => {
  ...
  // 发送通知
  !$.not_translate && debug(obj, "翻译结果") && $.msg($.name, '', `成功翻译 ${success_num} 次, 用时 ${costTime} 秒 🎉`);
  // 返回修改后的 body
